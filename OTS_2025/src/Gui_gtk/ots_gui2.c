 ...
 switch (selected_form)
  {
   ...
   default:
	...
	if (strstr( taxsolvestrng, "taxsolve_f8812" ) != 0)
	  check_form_version( title_line, "Title:  Form 8812 - 2025" );
	else
	if (strstr( taxsolvestrng, "taxsolve_CA_5805" ) != 0)
    ...
    if (rptwd_txline)
     {
      ...
      // printf("INTERPRETTED '%s' as %d\n", rptwd_txline->text, round_pdf_to_whole_dollars );
     }
    if (round_pdf_to_whole_dollars)
