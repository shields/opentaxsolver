...
/* 									*/
/* Compile:   cc taxsolve_ma_1_2025.c -o taxsolve_ma_1_2025		*/
/* Run:       ./taxsolve_ma_1_2025  Mass1_2025.txt			*/
/* 									*/
 ...
 */
 ...
 check_form_version( word, "Title:  Massachusetts Form 1 Tax Form - 2025" );
 ...
 GetLine( "L39", &L[39] );	/* Last year's overpayment you want applied to 2025 estimated tax */
 ShowLineNonZero(39);

 GetLine( "L40", &L[40] );	/* 2025 estimated tax payments */
 ShowLineNonZero(40);
