...
char program_names[30][100] = 
	{
	 "taxsolve_US_1040_2022",		/* 0 */
	 "taxsolve_US_1040_Sched_C_2022",	/* 1 */
	 "taxsolve_US_8829",			/* 2 */
	 "taxsolve_CA_540_2022",		/* 3 */
	 "taxsolve_NC_D400_2022",		/* 4 */
	 "taxsolve_NJ_1040_2022",		/* 5 */
	 "taxsolve_OH_IT1040_2022",		/* 6 */
	 "taxsolve_PA_40_2022",			/* 7 */
	 "taxsolve_VA_760_2022",		/* 8 */
	 "taxsolve_NY_IT201_2022",		/* 9 */
	 "taxsolve_MA_1_2022",			/* 10 */
	 "taxsolve_GA_500",			/* 11 */
	 "Other",				/* xx */
	};
 ...
 switch (selected_form)
  {
   ...
   case form_OH_IT1040: check_form_version( title_line, "Title:  Ohio IT1040 State" );
	break;
   case form_VA_760: check_form_version( title_line, "Title:  VA-760 State 2022" );
	break;
   case form_NJ_1040: check_form_version( title_line, "Title:  NJ-1040 State 2022" );
	break;
   case form_NY_IT201: check_form_version( title_line, "Title:  NY State 2022" );
	break;
   case form_MA_1: check_form_version( title_line, "Title:  Massachusetts Form 1 Tax Form" );
	break;
   case form_NC_D400: check_form_version( title_line, "Title:  NC State Tax Form 400 for 2022" );
	break;
   default:
	if (strstr( taxsolvestrng, "taxsolve_HSA_f8889" ) != 0)
	...
	if (strstr( taxsolvestrng, "taxsolve_f8960" ) != 0)
	  check_form_version( title_line, "Title: 2022 Form 8960" );
	else
	if (strstr( taxsolvestrng, "taxsolve_f2210" ) != 0)
	  check_form_version( title_line, "Title:  Form 2210 for Tax Year 2022" );
	else
	if (strstr( taxsolvestrng, "taxsolve_CA_5805" ) != 0)
 ...
 if (strcmp(strg,"Other")==0)
  {
   ...
   fb_ban_files( "taxsolve_US_1040_2022");
...
void helpabout1( GtkWidget *wdg, void *data )
{
 ...
 strcat( msg, "                For the 2022 Tax Year.    OTS release ");
