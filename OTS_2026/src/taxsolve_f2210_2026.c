...
/*-----------Tax Routines Copied From taxsolve_US_1040_2026.c----------------*/
...
/* 2026 Tax Rate Schedule for Estates/Trusts - From 2026 Form 1041 Instructions, page 30 */
 ...
 */
 ...
 check_form_version( word, "Title:  Form 2210 for Tax Year 2026" );

 // fprintf(outfile,"\n--- THIS IS PRELIMINARY USER-CONTRIBUTED FORM ---\n");
 // MarkupPDF( 1, 240, 40, 17, 1.0, 0, 0 ) NotReady "This program is NOT updated for 2026."
