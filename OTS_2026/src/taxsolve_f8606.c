...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  check_form_version( word, "Title: Form 8606 for tax-year 2026" );
  ...
  if (complete_part_one) {
    ...
    if (!dist_or_conv) {
      ...
      if (L15c > 0.0) {
        showline_wlabelmsg(
            "L15c", L15c,
            "Taxable Amount: include this amount on 2026 Form 1040 or 1040-SR, "
            "line 4b; or 2026 Form 1040-NR, line 16b" );
      } else {
    ...
    if (L[21] > 0 && L[23] > 0) {
      ...
      if (L25a > 0) {
        showline_wlabelmsg("L25b", L25b,
                           "Also, enter this amount on 2026 Form 8915-C, line "
                           "23, or 2026 Form 8915-D, line 14, as applicable");

        L25c = L25a - L25b;
        if (L25c > 0) {
          showline_wlabelmsg(
              "L25c", L25c,
              "Also include this amount on 2026 Form 1040 or 1040-SR, line 4b; "
              "or 2026 Form 1040-NR, line 16b.");
