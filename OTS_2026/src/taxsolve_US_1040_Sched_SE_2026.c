...
int main( int argc, char *argv[] )
{
 ...
 printf("US 1040 Schedule SE, 2026 - v%1.0f\n", thisversion);
 ...
 /* Expect lines, something like:
        Title:  1040 Schedule SE - 2026 Return
        L2              {Net Profit/Loss}
        . . .
 */
 ...
 check_form_version( word, "Title:  1040 Schedule SE - 2026" );
 ...
 GetTextLineF( "YourSocSec#:" );
											...
											/* Updated for 2026. */
								/* -- Uncomment and implement these lines for 2026. -- */
 ...
 L[7] = 176100.0;           	/* Constant value for tax year 2026 */			/* Updated for 2026. */
 ...
 showline(3);
 if (L[3] > 0.0)
  L4a = L[3] * 0.9235;									/* Updated for 2026. */
 else
  L4a = L[3];
 ...
 if (!stop)
  { /*!stop*/
    ...
    L[11] = L[6] * 0.029;									/* Updated for 2026. */
    showline(11);
    L[12] = L[10] + L[11];
