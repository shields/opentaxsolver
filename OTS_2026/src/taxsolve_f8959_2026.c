 ...
 */
 ...
 check_form_version( word, "Title: 2026 Form 8959" );
 ...
 // fprintf(outfile,"--- NOT YET FULLY UPDATED FOR 2026. ---\n\n");
 ...
 if(status == MARRIED_FILING_JOINTLY)
	L[5] = 250000.00;			// Checked/Updated for tax-year 2026.
 ...
 GetLineF( "L8", &L[8] );
 if(status == MARRIED_FILING_JOINTLY)
	L[9] = 250000.00;			// Checked/Updated for tax-year 2026.
 else if(status == MARRIED_FILING_SEPARAT)
	L[9] = 125000.00;
 else if((status == SINGLE) || (status == HEAD_OF_HOUSEHOLD) || (status == WIDOW))
	L[9] = 200000.00;
 ...
 GetLineF( "L14", &L[14] );
 if(status == MARRIED_FILING_JOINTLY)
	L[15] = 250000.00;			// Checked/Updated for tax-year 2026.
 else if(status == MARRIED_FILING_SEPARAT)
	L[15] = 125000.00;
 else if((status == SINGLE) || (status == HEAD_OF_HOUSEHOLD) || (status == WIDOW))
	L[15] = 200000.00;
 ...
 showline( 16 );
 L[17] = L[16] * 0.009;				// Checked/Updated for tax-year 2026.
 showline( 17 );
 L[18] = L[7] + L[13] + L[17];
...
(Form 1040-PR or 1040-SS filers, see instructions)" );
 ...
 L[20] = L[1];
 showline( 20 );
 L[21] = L[20] * 0.0145;			// Checked/Updated for tax-year 2026.
