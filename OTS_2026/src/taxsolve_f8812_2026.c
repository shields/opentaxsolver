 ...
 */
 ...
 check_form_version( word, "Title: Form 8812 - 2026" );
 ...
 L[5] = L[4] * 2200.0;		// Updated for tax-year 2026.
 showline( 5 );
 ...
 L[7] = L[6] * 500.0;		// Checked/Updated for tax-year 2026.
 showline( 7 );
 ...
 switch (status)
  {				// Checked/Updated for tax-year 2026.
 ...
 L[11] = L[10] * 0.05;		// Checked/Updated for tax-year 2026.
 showline( 11 );
 ...
 if (L[8] <= L[11])
  ...
  { /*A*/
   ...
   if ((L16a <= 0.0) || (L[4] == 0.0))
    ...
    { /*C*/
     L16b = 1700.0 * L[4];		// Checked/updated for tax-year 2026.
     ...
     if (L16b > 0.0)
      { /*D*/
       ...
       if (L18a > 2500.0)
        { /*E*/
	 L[19] = L18a - 2500.0;		// Checked/updated for tax-year 2026.
	 showline( 19 );
	 fprintf(outfile,"CkL19y = X\n");
	 L[20] = L[19] * 0.15;
	 showline( 20 );

	 if (L16b <= 5100.0)		// Checked/updated for tax-year 2026.
	  { /*F*/
 ...
 if (L[27] > 0.0)								// Checked for tax-year 2026.
