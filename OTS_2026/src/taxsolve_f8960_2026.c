 ...
 */
 ...
 check_form_version( word, "Title: 2026 Form 8960" );
 ...
 if(individual == Yes){
   ...
   if( status == MARRIED_FILING_JOINTLY)
	  L[14] = 250000.00;			// Updated/checked for tax-year 2026.
   ...
   showline( 16 );
   L[17] = L[16] * 0.038;			// Updated/checked for tax-year 2026.
