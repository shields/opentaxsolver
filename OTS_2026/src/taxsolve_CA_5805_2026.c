...
/* The following two tax functions copied from taxsolve_CA_540_2026.c. */
/* 2026 tax rates are used in California for calculating estimated taxes */
...
double		/* Reoccuring threshold values. */	/* Updated for 2026. */
	thresh_sep_single =	252203.0,
	thresh_mfj =		504411.0,
	thresh_HoH =		378310.0;

double		/* Other recurring values */		/* Updated for 2026 */
 ...
 */
 ...
 check_form_version( word, "Title:  Form 5805 for Tax Year 2026" );

 #if (0)
   add_pdf_markup( "NotReady", 1, 240, 40, 17, 1, 1.0, 0, 0, "\"This program is NOT ready for 2026.\"" );
   fprintf(outfile, "This program is NOT ready for 2026.\n\n");
   #ifdef microsoft
